...
STORIES = {
    ...
    "塩無添加-鹿児島枕崎-かつお削り節": {
        "h3": "ナトリウム0.1%。<br>犬と猫のための、かつお削り節",
        "lead": "鹿児島枕崎のかつおを、塩を使わずに加工した削り節。いつものごはんにふりかけるだけで、かつおの香りが立ち、食いつきが変わります。",
        "fit": ["食いつきにムラがある子", "塩分が気になる子", "トッピングが好きな子", "手作りごはんの子"],
        "imgs_fit": [],
        "sections": [
            ["「塩無添加」へのこだわり",
             'かつおを釣り上げて冷凍する際、勢いのある冷風で表面の塩水を吹き飛ばし、加工の段階でも塩を使いません。だから<span class="c_prodStory__em">ナトリウム0.1%</span>。塩分が気になるわんちゃん・猫ちゃんにも与えやすい削り節です。'],
            ["ふりかけて、だしを取って",
